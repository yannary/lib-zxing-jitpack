...
public class ScanDefineUiActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_scan_define);

        findViewById(R.id.scan_back_iv).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ScanDefineUiActivity.this.finish();
            }
        });
    ...
    CodeUtils.AnalyzeCallback analyzeCallback = new CodeUtils.AnalyzeCallback() {
        ...
        public void onAnalyzeSuccess(Bitmap mBitmap, String result) {
            ...
            ScanDefineUiActivity.this.setResult(RESULT_OK, resultIntent);
            ScanDefineUiActivity.this.finish();
        }
